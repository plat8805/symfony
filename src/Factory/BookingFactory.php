...
final class BookingFactory extends ModelFactory
{
    ...
    protected function getDefaults(): array
    {
        return [
            ...
            'total_price' => self::faker()->randomFloat($nbMaxDecimals = 2, $min = 1, $max = 3000),
            'shipping_price' => self::faker()->randomFloat($nbMaxDecimals = 2, $min = 1, $max = 3000),
            'shipping_method' => self::faker()->text(),
            'status' => self::faker()->boolean($chanceOfGettingTrue = 20),
        ];
    }
